class KeyboardTester extends Window {
	...
	InitializeKeyboard() {
		...
		this.win.onkeydown = event => {
			...
			this.keyElements[event.code].style.backgroundColor = "var(--theme-color)";
			this.keyElements[event.code].style.filter = "brightness(2.5)";
			this.keyElements[event.code].style.boxShadow = "var(--theme-color) 0 0 4px";
		};
		...
		this.win.onkeyup = event=> {
			...
			if (event.key === "PrintScreen") {
				...
				this.keyElements["PrintScreen"].style.backgroundColor = "var(--theme-color)";
			}
	...
	InitializeGamepad(forced = false) {
		...
		this.gpLeftButton.style.border = "1.5px solid #c0c0c0";
		...
		this.gpRightButton.style.border = "1.5px solid #c0c0c0";
		...
		this.gpLeftTrigger.style.border = "1.5px solid #c0c0c0";
		...
		this.gpRightTrigger.style.border = "1.5px solid #c0c0c0";
		...
		this.gpDLeft.style.border = "1.5px solid #c0c0c0";
		...
		this.gpDRight.style.border = "1.5px solid #c0c0c0";
		...
		this.gpDUp.style.border = "1.5px solid #c0c0c0";
		...
		this.gpDDown.style.border = "1.5px solid #c0c0c0";
		...
		this.gpA.style.border = "1.5px solid #c0c0c0";
		...
		this.gpB.style.border = "1.5px solid #c0c0c0";
		...
		this.gpX.style.border = "1.5px solid #c0c0c0";
		...
		this.gpY.style.border = "1.5px solid #c0c0c0";
		...
		leftStickBoarder.style.border = "1.5px solid #c0c0c0";
		...
		rightStickBoarder.style.border = "1.5px solid #c0c0c0";
		...
		this.gpLStick.style.backgroundColor = "#c0c0c0";
		...
		this.gpRStick.style.backgroundColor = "#c0c0c0";
		...
		this.gpShare.style.border = "1.5px solid #c0c0c0";
		...
		this.gpMenu.style.border = "1.5px solid #c0c0c0";
		...
		this.gpLogo.style.border = "1.5px solid #c0c0c0";
		...
		this.gpTrackPad.style.border = "1.5px solid #c0c0c0";
		...
		this.gpLeftTriggerLabel.style.color = "#c0c0c0";
		...
		this.gpRightTriggerLabel.style.color = "#c0c0c0";
		...
		this.gpLeftStickLabel.style.color = "#c0c0c0";
		...
		this.gpRightStickLabel.style.color = "#c0c0c0";
		...
		for (var j = 0; j < gamepads.length; j++) {
			...
			for (let i = 0; i < gamepad.buttons.length; i++) {
				if (gamepad.buttons[i].pressed) {
					anyButton = true;
					elements[i].style.backgroundColor = "var(--theme-color)";
					elements[i].style.filter = "brightness(2.5)";
					elements[i].style.boxShadow = "var(--theme-color) 0 0 4px";
				} else {
